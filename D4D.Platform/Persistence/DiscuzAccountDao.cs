...
namespace D4D.Platform.Persistence
{
    internal static class DiscuzAccountDao
    {
        ...
        internal static void MapUserInfo(IRecord record, DiscuzUserInfo userinfo)
        {
            ...
            userinfo.Credits = record.GetInt32OrDefault(offset++, 0); //Int32.Parse(reader["credits"].ToString());
            userinfo.Extcredits1 = record.GetFloat(offset++);// float.Parse(reader["extcredits1"].ToString());
            userinfo.Extcredits2 = record.GetFloat(offset++);//float.Parse(reader["extcredits2"].ToString());
            userinfo.Extcredits3 = record.GetFloat(offset++);//float.Parse(reader["extcredits3"].ToString());
            userinfo.Extcredits4 = record.GetFloat(offset++);//float.Parse(reader["extcredits4"].ToString());
            userinfo.Extcredits5 = record.GetFloat(offset++);//float.Parse(reader["extcredits5"].ToString());
            userinfo.Extcredits6 = record.GetFloat(offset++);//float.Parse(reader["extcredits6"].ToString());
            userinfo.Extcredits7 = record.GetFloat(offset++);//float.Parse(reader["extcredits7"].ToString());
            userinfo.Extcredits8 = record.GetFloat(offset++);// float.Parse(reader["extcredits8"].ToString());
