...
<div class="right floatleft">
  <div class="cd_right">
    <div class="w_562 h_578">
      ...
      <h1 class="floatleft blue" style="width:100%">Comments<span>-<a href="/photo/album/<%=Current.AlbumId%>/slider.html"><span class="blue font24"><%=Current.Title%></span></a></span> </h1>
	  </div>
        ...
        for (int i = 0; i < CommentList.Count; i++)
        {
	  	...
	  	<li>
			<a href="#" class="blue"><%=item.UserName%></a>  <span class="gray">created by <%=item.AddDate.ToString("yyyy-MM-dd HH:mm:ss")%></span> <%if (isAdmin)
                                                                                                                                      { %><del cid="<%=item.CommentId%>">É¾³ý</del><%} %><br />
