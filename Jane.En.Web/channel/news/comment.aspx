  ...
  <div class="cd_right">
    <div class="w_562 h_578">
	  ...
	  <div class="cd_title commend_title">
       <h1 class="floatleft blue" style="width:100%">Comments<span>-<a href="/news/d/<%=CurrentNews.NewsId%>.html"><span class="blue font24"><%=CurrentNews.Title%></span></a></span> </h1>
	  </div>
...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            BindNews();
            BindComments();
            CommentControl.ObjectId = NewsId;
            CommentControl.ObjectType = (int)ObjectTypeDefine.News;
        }
    ...
    private void BindComments()
    {
        ...
        CommentList = D4DGateway.CommentProvider.GetPagedComments(pager, PublishStatus.Publish, NewsId, ObjectTypeDefine.News);
