...
{
    public class DiscuzPasswordAuthInfo
    {
        private int m_uid = -1;
        public int Uid
        {
    ...
    /// 简短的用户信息描述类
    /// </summary>    
    public class DiscuzShortUserInfo
    {
        ...
        private int m_adminid;	//管理组ID
        private int m_groupid;	//用户组ID
        private int m_groupexpiry;	//组过期时间
        private string m_extgroupids;	//扩展用户组
        private string m_regip;	//注册IP
        private DateTime m_joindate;	//注册时间
        private string m_lastip;	//上次登录IP
        private DateTime m_lastvisit;	//上次访问时间
        private DateTime m_lastactivity;	//最后活动时间
        private DateTime m_lastpost;	//最后发贴时间
        private int m_lastpostid;	//最后发贴id
        private string m_lastposttitle;	//最后发贴标题
        private int m_posts;	//发贴数
    ...
    /// 完整用户信息描述类
    /// </summary>
    public class DiscuzUserInfo : DiscuzShortUserInfo
    {
        ...
        private DateTime m_authtime;	//验证码生成日期
