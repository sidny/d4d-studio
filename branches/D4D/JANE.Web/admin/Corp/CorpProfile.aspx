...
<form id="form1" runat="server">
     ...
     <asp:Literal ID="litId" runat="server" Visible="false"></asp:Literal>
       <table cellspacing="1" cellpadding="4" rules="all"  align="center" width="100%" class="grid">
         ...
         <tr>
            <th align="center" style="width: 30px;">Intro页logo</th>
            <td>
               <uc1:FileUpload ID="txtIntroLogo" runat="server" AutoCreateThumbnailImage="false" AutoShowAddWaterMark="false"/>
            </td>
         </tr>
       </table>
</form>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
		   ...
		   txtIntroLogo.UploadResult = D4DGateway.CorpInfoProvider.ReadProfileContent("intrologo");
        }
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
       ...
       // if (!string.IsNullOrEmpty(txtAdservice.Value))
		...
		D4DGateway.CorpInfoProvider.SetProfileContent("intrologo", txtIntroLogo.UploadResult,false);
