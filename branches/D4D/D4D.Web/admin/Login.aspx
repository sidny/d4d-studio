   ...
   function ChangeCode()
	    {
	        ...
	        if(GUID != null)
	        {
	            ...
	            { 
	                myImg.src = "../Control/ValidateCode.ashx?GUID="+GUID.innerHTML+"&flag="+date.getMilliseconds()
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="30%" align="left">
                                                                    <a id="A2" href="" onclick="ChangeCode();return false;">
                                                                        <asp:Image ID="ImageCheck" runat="server" ImageUrl="../Control/ValidateCode.ashx?GUID=GUID"
