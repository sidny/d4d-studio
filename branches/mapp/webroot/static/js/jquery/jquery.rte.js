...
if(typeof $.fn.rte === "undefined") {
    ...
    return this.each( function() {
        ...
        function enableDesignMode() {
            ...
            var doc = "<html lang='zh'><meta http-equiv='Content-Type' content='text/html; charset=utf-8'/><head>"+css+"</head><body class='frameBody'>"+content+"</body></html>";
        ...
        function toolbar() {
            var tb = $("<div class='rte-toolbar' id='toolbar-"+ element_id +"'><div>\
                ...
                <p>\
                    <a href='#' class='bold'><img src='"+opts.media_url+"bold.gif' alt='加粗' title='加粗' /></a>\
                    <a href='#' class='italic'><img src='"+opts.media_url+"italic.gif' alt='斜体' title='斜体' /></a>\
                </p>\
                <p>\
                    <a href='#' class='unorderedlist'><img src='"+opts.media_url+"unordered.gif' alt='列表' title='列表' /></a>\
                    <a href='#' class='link'><img src='"+opts.media_url+"link.png' alt='链接' title='链接' /></a>\
                    <a href='#' class='image'><img src='"+opts.media_url+"image.png' alt='图片' title='图片' /></a>\
                    <a href='#' class='disable'><img src='"+opts.media_url+"close.gif' alt='纯文本编辑' title='纯文本编辑' /></a>\
                </p></div></div>");
