...
<div class="pdbody">
	...
	<div class="writeList">
		...
		<dl class="clearfix">
			<dt>作品标题</dt>
			<dd><input type="text" name="title" class="txt-normal" value="<{$worksDetail[0].title}>" /></dd>
		</dl>
		<dl class="clearfix">
			<dt>缩略图</dt>
			<dd><textarea name="minimg" id="id_description2" class="rte-zone" height="150"><{$worksDetail[0].minimg}></textarea></dd>
		</dl>
		<dl class="clearfix">
			<dt>大图地址串</dt>
			<dd>
				<textarea name="text" id="id_description" class="rte-zone" height="150"><{$worksDetail[0].content}></textarea>
			</dd>
		</dl>
		<input type="hidden" name="id" value="<{$worksDetail[0].id}>" />
