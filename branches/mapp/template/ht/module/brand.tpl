...
<h2 class="contentTitle">服务品牌内容管理</h2>
<div class="pdbody">
	<form id="brandForm" action="/ajax/item_z.php" method="POST">
		<h3>服务品牌内容</h3>
		<div class="clearfix">
			<textarea name="text" id="id_description" class="rte-zone" height="150"><{$brandType[0].content}></textarea>
		</div>
		<br />

		<{if $brandType[0].id}>
		<input type="hidden" name="id" value="<{$brandType[0].id}>" />
		<{/if}>
