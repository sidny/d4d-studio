...
namespace D4D.DBUtility
{
    ...
    public class BaseSqlMapDao 
    {
        ...
        public BaseSqlMapDao()
        {
            ...
            sqlMap = IBatisNet.DataMapper.Mapper.Instance();
        }
        ...
        protected int ExecuteInsert(string statementName, object parameterObject)
        {
            ...
            try
            {
            	result = (int)sqlMap.Insert(statementName, parameterObject);
            }
            catch (Exception e)
            {
        ...
        /// <param name="statementName">操作名</param>
        /// <param name="parameterObject">参数</param>
        protected Boolean ExecuteExists(string statementName, object parameterObject)
        {
            try
            {
            	Object  o =  sqlMap.QueryForObject(statementName, parameterObject);
            	bool result = false;
